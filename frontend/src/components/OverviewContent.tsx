    ...
    <div className={`w-[95%]`}>
        <div className='w-[100%] h-[30vh] flex flex-col justify-center text-start' id="what-is-aman">
            ...
            <p className='text-[18px] mt-[3%]'>
                Aman is a Web3 platform that uses blockchain technology to create secure 
                and decentralized digital identity cards. While it allows for seamless global 
                transactions, its true power lies in its ability to enable individuals 
                to manage and verify their identities in a tamper-proof, transparent way. 
                Aman combines security and flexibility, allowing anyone to interact with 
                the platform and build applications that empower users to control their 
                digital identity. Learn more and explore how to get started:            
            </p>
        </div>
        ...
        <div className='w-[100%] h-[30vh] flex flex-col justify-center text-start' id="what-is-aman-used-for">
            ...
            <p className='text-[18px] mt-[3%]'>
                ...
                services that can enhance various aspects of our lives. 
                While we are still in the early stages, there’s plenty to look 
                forward to.
            </p>
        </div>
        <div className='w-[100%] h-[70vh] flex justify-between items-center'>
