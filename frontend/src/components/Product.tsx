        ...
        <div className="w-full max-w-7xl grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-20 px-4">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
              ...
              <p className="text-sm md:text-base">
                Ensures that identity, certificates, and stamps are authentic
                and digitally valid.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
              ...
              <p className="text-sm md:text-base">
                All data is securely stored on the blockchain and cannot be
                altered.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
              ...
              <p className="text-sm md:text-base">
                Simplifies the authentication process for documents or identity
                anytime, anywhere.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
              ...
              <p className="text-sm md:text-base">
                Easily accessible across digital platforms without geographical
                limitations.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
              ...
              <p className="text-sm md:text-base">
                Saves costs, time, and eliminates the need for physical
                documents.
              </p>
            </div>
          </motion.div>
