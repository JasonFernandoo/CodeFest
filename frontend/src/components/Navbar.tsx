      ...
      >
        <div className="h-[70px] w-full flex justify-between items-center px-4 md:px-8">
          ...
          <div className="flex items-center gap-[10px]">
            ...
            ></i>
            <i
              className="fa-solid fa-wallet h-[45px] w-[45px] rounded-[10px] bg-[#d9d9d940] flex justify-center items-center hover:bg-[#89898930] transform transition-transform duration-500 hover:cursor-pointer hover:rotate-12"
              onClick={toggleCart}
            ></i>
      ...
      <div>
        {cartOpen && (
          <>
            <div
              ref={cartRef}
              className={`fixed top-[70px] right-0 h-full w-[300px] shadow-lg transform transition-transform duration-500 translate-x-0 z-[900] ${
            ...
            >
              <div className="p-4 flex flex-col text-start">
                ...
                <p className="my-[5%] leading-tight">
                  Connect your wallet to purchase our services.
                </p>
                <button className="h-[40px] w-[270px] bg-[#b79ffc] rounded-[5px] text-white">
                  CONNECT YOUR WALLET
                </button>
              </div>
            </div>
            <div
              className="fixed inset-0 bg-black opacity-50 z-[800]"
              onClick={toggleCart}
            ></div>
          </>
        )}
