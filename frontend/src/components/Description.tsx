...
const Description = () => {
  ...
  return (
    <>
      <div
        className={`h-[50vh] w-[100vw] flex items-center transition duration-500 px-20 ${
          darkMode
      ...
      >
        ...
        <div className="w-[100vw] flex justify-end items-center px-30">
          ...
          />
          <img
            className="w-50 animate-rotate-right-left"
            src="./char2-right.png"
            alt=""
          />
        </div>
      ...
      <div
        className={`h-[40vh] w-[100vw] flex justify-end items-start transition duration-500 px-20 ${
          darkMode
            ? "bg-black text-white text-3xl"
            : "bg-white text-black text-3xl"
        }`}
      >
        <div className="w-[100vw] flex justify-start items-center pl-20">
          <img
            className="w-32 parallax ml-[-30vw]"
            src="./char1-right.png"
            alt=""
          />
        </div>
