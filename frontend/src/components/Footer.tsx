...
const Footer = () => {
  ...
  // Destructure the selected contact's details
  const selectedContactDetails = selectedContact ? contacts[selectedContact] : null;

  return (
    <footer className={`h-[35vh] w-[100vw]`}>
      <div className={`h-full w-full flex flex-col justify-center items-center ${darkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
        <div className='h-[80%] w-[97.5%] flex justify-center items-center'>
          <div className='h-[85%] w-[25%] flex flex-col items-start'>
            ...
            <p className="font-bold text-[#b79ffc] mt-[-2%] mb-[7%]">DIGITAL CHAIN IDENTITY</p>
              ...
              {selectedContactDetails ? (
                <>
                  <div className="flex flex-col text-start ml-[5%]">
                    <h1 className="w-[400px] text-start text-[20px] text-[#b79ffc]">{selectedContact}</h1>
                ...
                <>
                  <img className="min-w-[150px] h-[150px] rounded-full" src={defaultImage} alt="Default" />
                  <p className="w-[400px] ml-[5%] text-start">
                    AMAN is a trusted solution to transform your digital identity into a unique, secure, and easily accessible asset through blockchain technology.
                  </p>
                </>
              )}
            </div>
        ...
        <div className={`h-[20%] w-[97.5%] flex justify-center items-center border-t-[0.1px] ${darkMode ? 'border-white' : ''}`}>
